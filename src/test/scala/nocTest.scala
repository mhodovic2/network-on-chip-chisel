...
class nocTest(dut:noc) extends PeekPokeTester(dut) {
  ...
  */
  ...
  poke(dut.io.NI_din, value = "b00000000000000000000000000001010".U /*0x0000000AL*/)
  poke(dut.io.NI_valid_in, value = 1L)
  ...
  poke(dut.io.NI_ready_in, value = 1L)

  step(1)
  poke(dut.io.NI_valid_in, value = 0L)
